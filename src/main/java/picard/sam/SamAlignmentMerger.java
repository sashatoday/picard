...
public class SamAlignmentMerger extends AbstractAlignmentMerger {
    ...
    private final List<String> matchingDictionaryTags;
     ...
     *
     * @param matchingDictionaryTags            A list of SAMSequenceRecord tags that must be equal (if present) in the aligned bam and the reference dictionary.
    ...
    public SamAlignmentMerger(final File unmappedBamFile, final File targetBamFile, final File referenceFasta,
                              ...
                              final List<String> matchingDictionaryTags) {
        ...
        this.matchingDictionaryTags = matchingDictionaryTags;
